...
class MacOSWindow extends DesktopWindow {
  ...
  Size? _titleBarButtonSize;

  Size get titleBarButtonSize {
    if (_titleBarButtonSize != null) return _titleBarButtonSize!;
  ...
  set titleBarButtonSize(Size size) {
    this._titleBarButtonSize = size;
  }

  double? _titleBarHeight;

  double get titleBarHeight {
    if (_titleBarHeight != null) return _titleBarHeight!;
